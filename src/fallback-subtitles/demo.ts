// Hard-coded fallback subtitle content for demo video (xRh2sVcNXQ8)
// Used when both direct youtubei.js and proxy subtitle extraction fail

export const DEMO_SUBTITLE = `人工智能正在以前所未有的速度改变我们的世界。今天我们邀请到了硅谷知名投资人马克·安德森，来讨论AI革命的万亿美金之问。
